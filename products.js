// ═══════════════════════════════════════════════════════════
//  PRODUCT DATABASE
//  Change prices, names, descriptions here!
// ═══════════════════════════════════════════════════════════
...
const products = [
    {
        id: 1,
        name: "DentalLux Pro",
        price: 149.99,  // ← Change price here!
        image: "images/product-1.jpg",  // ← Your image path
        fallback: "https://images.unsplash.com/photo-1607613009820-a29f7bb81c04?w=400&q=80",
        badge: "Best Seller",
...
//  1. Copy one of the product blocks above
//  2. Change the id to the next number (7, 8, etc.)
//  3. Change name, price, description
//  4. Add your image to images/ folder
